  ...
  render() {
    return (
      <div id="modalusers"  onClick={ (e) => {
        if (e.target.id === e.currentTarget.id) this.props.closemodaladduser(e)
      }}>
                ...
                <div className="card-panel clearfix">
                   ...
                   <div className="input-field col m12">
                    ...
                    <div className="modal-footer">
                      <a onClick={(e) => this.props.closemodaladduser(e)} className="modal-action modal-close waves-effect waves-red btn-flat ">Disagree</a>
